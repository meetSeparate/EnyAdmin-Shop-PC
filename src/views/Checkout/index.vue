...
<template>
  ...
  <!-- 切换地址 -->
  <el-dialog v-model="dialogValue" title="切换收货地址" width="30%" center>
    <div class="addressWrapper">
      <div class="text item" :class="{active: activeAddress.id === item.id}" v-for="item in checkInfo.userAddresses"
           :key="item.id" @click="changeActiveAddress(item)">
        <ul>
    ...
    <span class="dialog-footer">
      ...
      <el-button type="primary" @click="changeCurAddress">确定</el-button>
    </span>
    </template>
  </el-dialog>
  <!-- 添加地址 -->
